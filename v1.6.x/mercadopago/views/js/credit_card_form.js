    ...
    (function(global) {
      ...
      Card = (function() {
        ...
        Card.prototype.defaults = {
          formatting: true,
          formSelectors: {
            numberInput1: "input[name='cardNumber'",
        ...
        Card.prototype.render = function() {
          console.log(this);
          console.info("=====numberInput====" + this.$numberInput);
          console.info("=====numberInput1====" + this.$numberInput1);
          console.info("=====expiryInput====" + this.$expiryInput);
        ...
        Card.prototype.attachHandlers = function() {
          ...
          bindVal(this.$cvcInput, this.$cvcDisplay, {
            filters: this.validToggler('securityCode')
          });
        ...
        Card.prototype.validToggler = function(validatorName) {
          ...
          } else if (validatorName === "securityCode") {
