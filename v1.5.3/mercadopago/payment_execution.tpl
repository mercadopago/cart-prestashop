...
<h3>
	{l s='Pagamento via MercadoPago' mod='mercadopago'}
</h3>
...
<form action="{$this_path_ssl}validation.php" method="post">
	...
	<p>
		<b>
			{l s='Por favor confira as formas de pagamento aceitas pelo MercadoPago e 
		confirme sua compra clicando em \'Confirmar Compra\'' mod='mercadopago'}.
		</b>
	</p>
	
	<p>
		<center>
			<img src="{$imgBnr}" alt="{l s='Formas de Pagamento MercadoPago' mod='mercadopago'}">
		</center>
	</p>
