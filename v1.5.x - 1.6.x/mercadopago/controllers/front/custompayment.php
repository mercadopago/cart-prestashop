       ...
       // card_token_id
        ...
        if ($order_status != null) {
            ...
            if (Tools::getIsset ( 'card_token_id' )) {
                ...
                $uri .= '&card_token=' . Tools::getValue ( 'card_token_id' ) . '&card_holder_name=' . Tools::getValue ( 'cardholderName' ) . '&four_digits=' . $four_digits . '&payment_method_id=' . $response ['payment_method_id'] . '&payment_type=' . $response ['payment_type_id'] . '&installments=' . $response ['installments'] . '&statement_descriptor=' . $response ['statement_descriptor'] . '&status_detail=' . $response ['status_detail'] . '&amount=' . $response ['transaction_amount'];
            } else {
            ...
            if (array_key_exists ( 'message', $response ) && (strpos ( $response ['message'], 'Invalid users involved' ) !== false || (strpos ( $response ['message'], 'users from different countries' ) !== false))) {
                ...
                $data ['amount'] = Tools::displayPrice ( $response ['transaction_amount'], new Currency ( Context::getContext ()->cart->id_currency ), false );
